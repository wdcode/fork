    ...
    static {
        ...
        if (canUseSunUnsafeReflectionProvider()) {
            ...
            if (cls != null) {
                try {
                    try {
//                        provider.writeField(t, "o", "object", Jvm.class);
...
//                        provider.writeField(t, "bool", Boolean.TRUE, Test.class);
        ...
        try(CustomObjectOutputStream c = new CustomObjectOutputStream(null)) {
            test = c != null;
        } catch (RuntimeException e) {
            test = false;
        } catch (IOException e) {
        ...
        if (base64Class != null) {
            try {
                base64 = (StringCodec)base64Class.getDeclaredConstructor().newInstance();
