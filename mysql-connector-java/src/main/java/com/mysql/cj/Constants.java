...
public class Constants {
    ...
    public static final String CJ_FULL_NAME = "mysql-connector-java-8.0.19";
    public static final String CJ_REVISION = "a0ca826f5cdf51a98356fdfb1bf251eb042f80bf";
    public static final String CJ_VERSION = "8.0.19";
