 ...
 * <p>
 * See the Guava User Guide article on <a href="https://github.com/google/guava/wiki/FunctionalExplained">the use of
 * {@code Predicate}</a>.
 *
...
public final class Predicates {
	 ...
	 * true}. The components are evaluated in order, and evaluation will be "short-circuited" as soon as a false
	 * predicate is found.
	 */
	 ...
	 * If the object being tested is {@code null} this predicate evaluates to {@code
	 * false}.
	 * <p>
	 ...
	 * This approach doesn't block any potential users since it is always possible to use
	 ...
	 * for the given regular expression pattern. The test used is equivalent to
	...
	/**
	 * Returns a predicate that evaluates to {@code true} if the {@code CharSequence} being tested contains any match
	 * for the given regular expression pattern. The test used is equivalent to {@code pattern.matcher(arg).find()}
	 *
	 * @since 3.0
	 */
